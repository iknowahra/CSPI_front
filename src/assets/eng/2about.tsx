const aboutEng = {
  ...
  ceoRight: {
    ...
    sub: '30,000+',
    contents:
      'CSPI는 앱 다운로드 30,000명 이상의 앱 사용자의 충분한 피드백을 통해 검증된 서비스를 제공합니다.',
  },
  access: {
    title:
      '베트남 IT 한인 기업들의 즐겁고 편리한 \nIT 아웃소싱 서비스 및 커뮤니티',
    details: `언제나 어디서나, 즐겁고 편리한 액세스가 가능합니다.\n회원 가입은 쉽고 간단합니다.\n무료 회원 가입 후 로그인하시면 업데이트 된 CSPI의 서비스를 받으실 수 있습니다.`,
  },
};
